    ...
    return (
        ...
        >
            <div className=' h-[60vh] w-full bg-black rounded-t-3xl p-2'>
                <button onClick={() => setIsPrivacyPolicyModalOpen(false)} className=' mb-[20px] block cursor-pointer w-[100px] h-[4px] rounded-full bg-white/30 mx-auto'></button>
                <h1 className=' font-extrabold text-3xl text-center mb-[10px]'>Privacy Policy</h1>
                <p className=' text-white/30 text-center mb-[10px]'>Read through our privacy policy</p>
