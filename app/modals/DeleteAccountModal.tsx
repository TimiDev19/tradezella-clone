        ...
        >
            <div className=' h-fit w-full bg-white dark:bg-black rounded-t-3xl'>
                <div className=' h-full p-2 w-[70%] mx-auto'>
                    ...
                    <h1 className=' font-extrabold text-3xl mb-[10px] text-black dark:text-white'>Reason for deletion?</h1>
                    <p className=' text-black dark:text-white/30 mb-[10px]'>Please select your reason for delting your Agent X account</p>
                    ...
                    <div className=' w-full flex items-center justify-between'>
                        <button onClick={() => setIsDeleteAccountModalOpen(false)} className=' w-[49%] text-center bg-black dark:bg-[#AB4FA8] text-white py-[10px] px-[100px] rounded-md hover:bg-black/60 dark:hover:bg-[#AB4FA8]/60 duration-500'>Cancel</button>
